...
A lightweight, responsive, and accessible implementation of a dark mode toggle. This project supports localisation (including region-specific language codes), right-to-left (RTL) languages, and manual override functionality. It dynamically adapts to user preferences and system settings while ensuring robust accessibility. Additionally, the dark mode remains functional even if JavaScript is disabled.

## Features

- **Theme switching:** Easily toggle between light and dark modes with smooth transitions.
- **Localisation:** Tooltips for the toggle button are available in multiple languages, including support for region-specific language codes and RTL languages.
...
- **Fallback support:** Dark mode functionality works even when JavaScript is disabled, ensuring a consistent experience across different user scenarios.
...
- **Modular and maintainable code:** Encapsulates JavaScript within an Immediately Invoked Function Expression ([IIFE](https://en.wikipedia.org/wiki/Immediately_invoked_function_expression "Immediately Invoked Function Expression (IIFE)")) to prevent global namespace pollution and organise code for easy maintenance and scalability.
...
1. Toggle Dark Mode:
   ...
   - Tooltips for the toggle button will be displayed in your browser’s preferred language, with proper alignment for both RTL and LTR layouts.
...
- **Desktop Browsers**:
  ...
  - Microsoft Edge
  - Mozilla Firefox
  - Opera (feedback is welcome for untested browsers!)
- **Mobile Browsers**:
  - Mobile Safari (iOS)
  - Chrome for Android
  - Firefox for Android
...
To customise the theme’s appearance, edit the `dark-mode.css` file. You can adjust colours, transitions, and layout as needed. Utilise CSS variables defined under `:root` and `[data-theme="dark"]` for consistent theming.
...
- **Accessibility audits**: Conduct comprehensive accessibility audits to ensure compliance with the latest accessibility standards and best practices.
...
1. Submit a pull request:
   - Navigate to your repository and click the `Contribute` button; then click on `Open pull request`. Provide a clear description of your changes and click on `Create pull request`.
...
This project is licensed under the [MIT License](https://opensource.org/license/mit "MIT License"). You are free to use, modify, and distribute this project in compliance with the licence terms.
